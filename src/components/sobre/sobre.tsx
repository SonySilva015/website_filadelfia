...
const valores = [
    {
        ...
        titulo: "Palavra",
        desc: "Fundamentados na Bíblia como regra de fé e prática, buscando conhecer e viver os ensinamentos de Cristo diariamente."
    },
    {
        icon: <Users size={20} strokeWidth={1.5} />,
        titulo: "Comunhão",
        desc: "Valorizamos a comunhão fraternal, compartilhando a vida, as alegrias e as dificuldades, fortalecendo os laços de irmandade em Cristo Jesus."
    },
    {
        icon: <Heart size={20} strokeWidth={1.5} />,
        titulo: "Amor",
        desc: "O amor de Deus nos motiva a amar sem medidas, acolher sem julgamentos e cuidar uns dos outros com genuíno afeto."
    },
    {
        icon: <HandHeart size={20} strokeWidth={1.5} />,
        titulo: "Serviço",
        desc: "Servimos a Deus através do serviço ao próximo, colocando nossos dons e talentos à disposição da igreja e da comunidade."
    }
];

export default function SobreIgrejaPage() {
    return (
        <div className="min-h-screen bg-tertiary text-body selection:bg-blue/10">
            {/* HEADER */}
            <header className="relative min-h-[85vh] flex items-center pt-20 overflow-hidden bg-blue">
                <div className="absolute inset-0 z-0">
                    ...
                    <div className="absolute inset-0 bg-linear-to-t from-slate-950 via-blsalate-950/30 to-transparent" />
                </div>
                    ...
                    >
                        <h1 className="text-5xl md:text-7xl lg:text-9xl font-serif text-white leading-[1.1] mb-10 tracking-tight">
                            ...
                            >
                                Filadélfia
                                <motion.span
                                    className="absolute bottom-0 left-0 w-full h-1 sm:h-2 bg-blue rounded-full"
                                    initial={{ width: 0 }}
                                    animate={{ width: "100%" }}
                                    transition={{
                                        delay: 1.0,
            ...
            >
                <div className="max-w-4xl mx-auto text-center">
                    <motion.h2
                        className="text-3xl sm:text-4xl md:text-5xl font-bold text-title mb-5 relative"
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
            ...
            {/* SEÇÃO 1: MISSÃO */}
            <motion.section
                className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-tertiary"
                initial={{ opacity: 0 }}
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
                        ...
                        >
                            ...
                            />
                            <div className="absolute inset-0 bg-linear-to-t from-blue/60 via-blue/30 to-transparent" />
                        </motion.div>
                        ...
                        >
                            ...
                            >
                                <motion.p
                                    className="text-base sm:text-lg text-body mb-4"
                                    initial={{ opacity: 0, y: 20 }}
                                    whileInView={{ opacity: 1, y: 0 }}
                                    viewport={{ once: true }}
                                    transition={{ delay: 0.2, duration: 0.6 }}
                                >
                                    <strong className="text-title">Glorificar a Deus</strong> através da proclamação do Evangelho
                    ...
                    <div className="grid md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <Compass className="text-blue mt-1 shrink-0" size={20} />
                                    <div>
                                        <h4 className="font-semibold text-title mb-1">Visão de Futuro</h4>
                                ...
                                >
                                    <Award className="text-blue mt-1 shrink-0" size={20} />
                                    <div>
                                        <h4 className="font-semibold text-title mb-1">O que fazemos?</h4>
                                        <p className="text-body">
            ...
            <motion.section
                className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-tertiary relative overflow-hidden"
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                viewport={{ once: true, amount: 0.1 }}
                transition={{ duration: 0.8 }}
            >
                ...
                <div className="max-w-6xl mx-auto relative z-10">
                    ...
                    >
                        <motion.span
                            className="text-blue font-semibold tracking-wider uppercase text-xs sm:text-sm block mb-3"
                            initial={{ opacity: 0, y: 10 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            transition={{ delay: 0.1, duration: 0.4 }}
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-title relative inline-block">
                            <span className="relative inline-block">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                        {valores.map((v, i) => (
                            ...
                            >
                                <motion.div
                                    className="w-12 h-12 bg-blue-light rounded-lg flex items-center justify-center text-blue mb-6"
                                ...
                                <h3 className="text-xl font-bold text-title mb-3 relative inline-block">
                                    <span className="relative">
                                        {v.titulo}
                                        <motion.span
                                            className="absolute -bottom-1 left-0 h-0.5 bg-blue/60 rounded-full"
                                            initial={{ width: 0 }}
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
                        ...
                        >
                            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
                                <motion.div
                                    ...
                                    transition={{ delay: 0.2, duration: 0.5 }}
                                >
                                    <div className="bg-blue-light p-3 rounded-lg text-blue">
                                        <MapPin size={24} />
                                    </div>
                                    <div>
                                        <h3 className="text-xl font-bold text-title mb-2">Endereço Principal</h3>
                                        <p className="text-body">
                                            Luena, Moxico<br />
                                ...
                                >
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-title mb-2">Como Chegar</h3>
                                        <p className="text-body">
                        ...
                        >
                            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
                                <motion.h3
                                    className="text-2xl font-bold text-title mb-6"
                                    initial={{ opacity: 0, y: 20 }}
                                    whileInView={{ opacity: 1, y: 0 }}
                                    viewport={{ once: true }}
                                ...
                                >
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-title mb-1">Horário de Cultos</h4>
                                        <p className="text-body mb-1">Domingo: 09h:30min</p>
                                    </div>
                                </motion.div>
                            </div>
                        </motion.div>
            ...
            {/* CALL TO ACTION */}
            <motion.section
                className="py-20 sm:py-24 md:py-32 px-4 sm:px-6 text-white"
                style={{
                    background: 'linear-gradient(to bottom right, var(--color-blue), var(--color-blue-hover))'
                }}
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                viewport={{ once: true, amount: 0.3 }}
            ...
            >
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        <motion.button
                            className="px-8 py-4 bg-white text-blue rounded-full font-semibold hover:bg-blue-light transition-colors shadow-lg"

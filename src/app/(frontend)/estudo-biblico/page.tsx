                ...
                <div className="max-w-4xl mx-auto relative z-10">
                    ...
                    >
                        ...
                        <p className="text-xl text-slate-100 font-light leading-relaxed max-w-2xl">
                            Nossos estudos bíblicos não são apenas ensinos; são mergulhos guiados na mente de Deus,
            ...
            <section className="py-32 border-t bg-gray-800 border-slate-100">
                <div className="max-w-6xl mx-auto px-6">
                    <div className="text-center mb-20">
                        ...
                        <p className="text-slate-100 font-light max-w-xl mx-auto">
                            As turmas são separadas de acordo a turma e estudadas de acordo o nível
                        </p>
                    </div>

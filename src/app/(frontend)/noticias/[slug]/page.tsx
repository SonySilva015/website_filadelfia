  ...
  return (
    <main className="min-h-screen bg-linear-to-b from-gray-50 to-white ">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 pt-4 pb-6 border-b border-gray-200">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-600">
                ...
                <span>
                  Por <span className="font-medium text-gray-900">{noticia?.autor?.email}</span>
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="relative w-full aspect-video max-h-[600px] mb-6 rounded-xl overflow-hidden shadow-lg">
          <Image
            src={capa? capa:''}
